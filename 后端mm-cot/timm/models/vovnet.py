...
from .layers import ConvBnAct, SeparableConvNormAct, BatchNormAct2d, ClassifierHead, DropPath,\
...
class VovNet(nn.Module):
    ...
    def __init__(self, cfg, in_chans=3, num_classes=1000, global_pool='avg', drop_rate=0., stem_stride=4,
        ...
        conv_type = SeparableConvNormAct if cfg["depthwise"] else ConvBnAct
